...
export function buildRiskData(){
  ...
  const categoriesRaw = [
    {
      name:'인재 리스크', icon:'👤', color:'#D14343', score:42,
      items:[
    ...
    {
      name:'조직 리스크', icon:'🏢', color:'#5BA0D9', score:55,
      items:[
    ...
    {
      name:'컴플라이언스', icon:'⚖️', color:'#FCAF17', score:18,
      items:[
    ...
    {
      name:'전략 리스크', icon:'🎯', color:'#E8572A', score:72,
      items:[
